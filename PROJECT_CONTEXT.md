...
- Default branch: `main`
- Current release/version: `ver(I.9.7.35)` / tag `vI.9.7.35`

## Current deployed state

- Latest deployed release is tracked by the active version/tag above and GitHub Pages build status.
- I.9.7.35 is deployed: Scroll lyrics stay blank before the first timestamp, then reveal the full lyric list so active, previous, and upcoming lines remain visible.
